...
File2 = "Volcano_plot_Cisternal_vs_Lumbar_Grouped.png"
File3 = "VVolcano_plot_Cisternal_vs_Lumbar_Grouped_labeled.png"
...
p1 <- ggplot(data %>%
  ...
  geom_hline(yintercept=-log10(0.05),linetype = "dashed", col="grey50")+
  geom_hline(yintercept=-log10(0.0399354037),linetype = "dashed", col="grey50")+
